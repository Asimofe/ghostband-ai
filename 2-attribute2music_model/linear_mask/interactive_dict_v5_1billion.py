            ...
            for id_, src_tokens, hypos, info in sorted(results, key=lambda x: x[0]):
                ...
                for hypo in hypos[: min(len(hypos), args.nbest)]:
                    ...
                    try:
                        ...
                        midi_obj.dump(save_root + f"/{infer_list[id_][1]}/midi/{current_time}.mid")
                    except:
                        pass
...
def cli_main():
    ...
    # add current_time
    parser.add_argument("--current_time", type=str, required=False, help="Current time as a string")
