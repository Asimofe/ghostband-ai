...
model_name="linear_mask-${model_size}" # linear_mask-xl


MODEL_NAME="${model_name}-${datasets_name}" # linear_mask_xl-truncated_5120
...
DATA_DIR="data_process/data/${datasets_name}"     # Data dir
